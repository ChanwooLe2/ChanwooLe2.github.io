...
excerpt: "Designed through Fusion 360 CAD software, the microfluidic device provies a much more effeicient way to rest fluids such as blood."
header:
...
* **Print and Cure Mold**
  1. Design a mold on a CAD software and print via Form 3 SLA resin printer (to maximize precision)
  2. Wash the mold for 5 minutes on the print bed and 5 minutes off the print bed facing down using an isopropanol alcohol bath.
  ...
  4. Cure the device for 5 seconds without heat.
* **Parylene Device, PDMS, and Plasma Bond glass slide**
  1. Place the cured prints into a Labcoter PDS 2010 machine to coat the molds with 2 grams of parylene-C. This protects the molds from outside contaminants that may corrode features.
  ...
  3. Place the mixture in a vacuum chamber to remove any air bubbles then cure in an oven at 80°C for 3 hours.
  4. Using PlasmaFlo PDC-FMG plasma cleaner, bond the PDMS devices and glass coverslips together then sterilize before use.

###### [Reference][1]

* Image of uFluidic Device Mold and Cast

![alt text](https://ChanwooLe2.github.io/assets/img/20240307_082429.jpg "Mold and Cast")
